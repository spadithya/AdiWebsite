...
- Noise-threshold algorithm validated against **30+ real datasets**, successfully flagging human-handling artifacts.
...
<PhotoGallery
  images={[
    ...
    { src: '/images/projects/photodiode-biomarker-sensor/emc-testing.jpg', alt: 'Device undergoing EMC Class B testing', caption: 'EMC Class B testing — Salt Lake City facility' },
  ]}
  columns={2}
/>
