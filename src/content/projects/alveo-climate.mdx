...
featured: false
order: 2
heroImage: "/images/projects/alveo-climate/alveo-climate-hero.jpeg"
...
<PhotoGallery
  images={[
    { src: '/images/projects/alveo-climate/hardware.jpeg', alt: 'Alveo Climate hardware module', caption: 'The module: Arduino Nano controller paired with the SHT85 sensor.' },
    { src: '/images/projects/alveo-climate/sensor.jpeg', alt: 'Sensirion SHT85 sensor in mounting fixture', caption: 'SHT85 in its mounting fixture, ready to drop into the airway.' },
  ]}
  columns={2}
  natural={true}
/>
